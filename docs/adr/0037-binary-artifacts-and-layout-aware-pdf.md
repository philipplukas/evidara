...
> **Amended by [ADR-0038](0038-geometric-pdf-marginalia.md) (2026-07-19).**
...
> booklet layout puts recto Randtitel on the right. ADR-0038 replaces the signal with
...
Status: Proposed (§3 signal and §4 gate superseded by ADR-0038)
Date: 2026-07-15
