...
| Document | Purpose |
|----------|---------|
| [ADR-0038: What makes a test result trustworthy](../adr/0038-test-result-trust.md) | Isolation → coverage honesty → assertion strength; when to believe a green run |
...
0. **Read [ADR-0038](../adr/0038-test-result-trust.md)** to understand when a green run is evidence.
