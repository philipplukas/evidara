...
- **Internal beta query/evidence pack:** for Hetzner staging, run [`scripts/check-internal-beta-query-pack.sh`](../../scripts/check-internal-beta-query-pack.sh) against [`scripts/fixtures/internal-beta-staging-expected.tsv`](../../scripts/fixtures/internal-beta-staging-expected.tsv), [`scripts/fixtures/internal-beta-staging-documents.tsv`](../../scripts/fixtures/internal-beta-staging-documents.tsv), and [`scripts/fixtures/internal-beta-staging-withdrawn-documents.txt`](../../scripts/fixtures/internal-beta-staging-withdrawn-documents.txt). It asserts top-5 expectations for the 5-10 beta queries, `q=*` exact four-document corpus health, detail metadata/tabs, and old synthetic document `404`s. Then use [`scripts/fixtures/internal-beta-staging-queries.txt`](../../scripts/fixtures/internal-beta-staging-queries.txt) for the Markdown relevance table. This proves the deterministic seed path only; it does not replace a broader corpus relevance baseline.
