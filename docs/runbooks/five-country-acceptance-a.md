...
- `platform-control/seeds/reference/{jurisdictions,authorities}.yaml` contain the canonical CH/AT jurisdiction and authority rows (including `jur_ch`, `jur_ch_federal`, `jur_at`, and `jur_at_federal`).
