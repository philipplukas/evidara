...
| [`product-argocd-application-staging.template.yaml`](product-argocd-application-staging.template.yaml) | Evidara product `Application` for **staging**; path ``k8s/gitops/staging``. |
| [`product-argocd-application.template.yaml`](product-argocd-application.template.yaml) | Evidara product `Application` for **prod**; path ``k8s/gitops/prod``. |
