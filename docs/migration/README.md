...
**Internal agent / OpenHands GitOps** lives in **`rocky-agents`** (separate repo, not Evidara / not
MacConfig product YAML): its own `k8s/overlays/` and Argo *product* app, while MacConfig keeps cluster
