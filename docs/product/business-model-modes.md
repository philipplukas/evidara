...
- **③ Channels** — the **GitHub repo itself**; a top-level README that hooks a reviewer in 60 seconds; a written **case study / blog post** ("how I designed a legal-data platform"); a **5-minute demo** (Loom/video); your CV & LinkedIn linking to specific artifacts; meetup/conference talks. **[repo exists [grounded]; the writeup/demo are the [gap] to close.]**
