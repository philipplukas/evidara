...
export const searchResults: SearchResultViewModel[] = [
  {
    ...
    badges: [{ label: "Law", colorKey: "law", iconKey: "ch" }],
    metadataRows: [
  ...
  },
  {
    ...
    badges: [{ label: "Court decision", colorKey: "decision", iconKey: "ch" }],
    metadataRows: [
  ...
  },
  {
    ...
    badges: [{ label: "Commentary", colorKey: "commentary" }],
    metadataRows: [
  ...
  },
  {
    ...
    badges: [{ label: "Rechtssatz", colorKey: "rechtssatz", iconKey: "at" }],
    metadataRows: [
  ...
  },
  {
    ...
    badges: [{ label: "Law", colorKey: "law", iconKey: "at" }],
    metadataRows: [
  ...
  },
  {
    ...
    badges: [{ label: "Court decision", colorKey: "decision", iconKey: "at" }],
    metadataRows: [
  ...
  relatedGroups: [
    {
      ...
      items: [
        { id: "d1", title: "BGer 4A_123/2022", subtitle: "Federal Supreme Court · 15.03.2022", badge: { label: "Decision", colorKey: "decision" } },
        { id: "d2", title: "BGer 4A_456/2021", subtitle: "Federal Supreme Court · 08.11.2021", badge: { label: "Decision", colorKey: "decision" } },
        { id: "d3", title: "BGer 4A_789/2020", subtitle: "Federal Supreme Court · 22.06.2020", badge: { label: "Decision", colorKey: "decision" } },
        { id: "d4", title: "HG Zürich HG190245", subtitle: "Handelsgericht Zürich · 03.09.2019", badge: { label: "Decision", colorKey: "decision" } },
      ],
    },
    {
      groupLabel: "Commentary",
      items: [
        { id: "c1", title: "Basler Kommentar OR II – Art. 754", subtitle: "Widmer/Banz · 7th ed. 2023", badge: { label: "Commentary", colorKey: "commentary" } },
        { id: "c2", title: "Zürcher Kommentar – Verantwortlichkeit", subtitle: "Forstmoser/Meier-Hayoz/Nobel · 5th ed. 2022", badge: { label: "Commentary", colorKey: "commentary" } },
      ],
    },
  ],
  references: [
  ...
  relatedGroups: [
    {
      ...
      items: [
        { id: "n1", title: "Art. 754 OR", subtitle: "Haftung der Verwaltung", badge: { label: "Law", colorKey: "law" } },
        { id: "n2", title: "Art. 717 OR", subtitle: "Sorgfalts- und Treuepflicht", badge: { label: "Law", colorKey: "law" } },
        { id: "n3", title: "Art. 8 ZGB", subtitle: "Beweislast", badge: { label: "Law", colorKey: "law" } },
      ],
    },
    {
      groupLabel: "Commentary",
      items: [
        { id: "c1", title: "Basler Kommentar OR II – Art. 754", subtitle: "Widmer/Banz", badge: { label: "Commentary", colorKey: "commentary" } },
      ],
    },
  ],
  references: [
