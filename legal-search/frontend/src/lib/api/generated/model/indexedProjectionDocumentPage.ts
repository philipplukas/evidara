 ...
 */
import type { IndexedProjectionDocument } from './indexedProjectionDocument';

export interface IndexedProjectionDocumentPage {
  data: IndexedProjectionDocument[];
  limit: number;
  /** Cursor to pass as `after` for the next page. Absent when the walk is complete. */
  next_after?: string;
}
