...
was found in this very document — so the acceptance run checked it directly: the
ordinance normalised into 9 sections with `"die Führung des Hundeverzeichnisses"`
intact and `Organisation` correctly separated as the Randtitel. See #735.
...
class GemeindeHttpProvider:
    ...
    def plan(self, source: Source, source_version: SourceVersion) -> ProviderPlan:
        ...
        notes.append(
            ...
            "evidenced against live Zürich AS 554.510 (2026-07-20, see #735). The template "
