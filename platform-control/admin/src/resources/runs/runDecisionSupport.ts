/**
 * Pure run decision-support / legal-search handoff helpers shared by the run
 * detail page and its tests. Extracted from the retired MUI `RunShow.tsx`
 * during the ADR-0026 cutover.
 */
